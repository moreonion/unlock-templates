	...
	$.fn.eActivistThermometer = function(options) {
		...
		return this.each(function() {
			...
			if(settings.dataUrl.length){
				...
				dataUrl = 'https://e-activist.com/ea-dataservice/data.service?service=' + settings.service + '&resultType=summary&contentType=json&token=' + settings.token + '&campaignId=' + settings.campaignId + '&callback=?';
			}
